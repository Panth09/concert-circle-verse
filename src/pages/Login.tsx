...
const ConcertCircleAuth = ({ onAuthComplete }) => {
  ...
  useEffect(() => {
    if (currentScreen === 'welcome') {
      const timer = setTimeout(() => {
        onAuthComplete(); // 🔥 Notify App that auth is done
      }, 4000);
      return () => clearTimeout(timer);
    }
  }, [currentScreen, onAuthComplete]);
  ...
  // 🔄 Replace the "main" screen with null
...
export default ConcertCircleAuth;
